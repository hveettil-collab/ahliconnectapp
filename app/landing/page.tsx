    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <main className="flex-1 flex flex-col">
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto text-center px-4 pt-16 pb-12 landing-fade-in">
            {/* Pill tag */}
            ...
            {/* Subtitle */}
            <p
              className="text-sm sm:text-base leading-relaxed max-w-xl mx-auto mb-8 px-2 md:px-4"
              style={{ color: 'var(--text-secondary)' }}
            >
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10 px-4 md:px-0">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center gap-2 text-white font-semibold px-7 py-3.5 rounded-2xl text-sm sm:w-auto w-full no-underline shadow-md"
                style={{ backgroundColor: 'var(--accent)' }}
              >
                Create Account
                <ArrowRight size={16} />
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 font-semibold px-7 py-3.5 rounded-2xl text-sm border sm:w-auto w-full no-underline"
                style={{
                  color: 'var(--text-primary)',
                  backgroundColor: 'var(--bg-card)',
                  borderColor: 'var(--border)',
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {FEATURES.map(({ icon: Icon, label, desc, color, bgColor }) => (
                <div
                  key={label}
                  className="rounded-2xl border p-5 hover:-translate-y-1 transition-all duration-200 cursor-default"
                  style={{
                    backgroundColor: 'var(--bg-card)',
                    borderColor: 'var(--border)',
        ...
        <section className="px-4 md:px-6 lg:px-8 py-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-2xl text-sm no-underline shadow-lg"
              style={{ backgroundColor: 'var(--accent)' }}
            >
              Create Your Account
              <ArrowRight size={16} />
      ...
      {/* ==================== FOOTER ==================== */}
      <footer
        className="border-t px-4 md:px-6 lg:px-8 py-5"
        style={{
          backgroundColor: 'var(--bg-card)',
          borderColor: 'var(--border)',
        }}
