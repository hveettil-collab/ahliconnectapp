  ...
  return (
    <AppShell title="Home" subtitle={time} hideTopBar>
      ...
      <div className="relative overflow-hidden" style={{ minHeight: 'clamp(320px, 52vh, 420px)' }}>
        ...
        {/* Top bar — padded below status bar safe area */}
        <div className="relative z-20 px-5" style={{ paddingTop: 'calc(env(safe-area-inset-top, 20px) + 8px)' }}>
