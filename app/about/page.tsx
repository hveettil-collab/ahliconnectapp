  ...
  return (
    <AppShell title="About Ahli Connect" subtitle="Platform Architecture & Capabilities">
      <div className="space-y-8">
        {/* Header Section */}
        <div className="text-center pb-6 border-b border-[#DFE1E6]">
          <h1 className="text-4xl font-bold text-[#15161E] mb-2">Ahli Connect</h1>
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <span className="px-3 py-1 bg-[#9D63F6] text-white text-xs font-semibold rounded-full">
              v1.0.0
            </span>
            <span className="px-3 py-1 bg-[#F7F1FF] text-[#9D63F6] text-xs font-semibold rounded-full">
        ...
        <section className="space-y-4">
          <div>
            <h2 className="text-2xl font-bold text-[#15161E] mb-3">Platform Overview</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={stat.label}
                className="bg-white rounded-[16px] border border-[#DFE1E6] p-4 text-center hover:shadow-md transition-all"
              >
                <div className="text-2xl font-bold text-[#9D63F6] mb-1">{stat.value}</div>
                <div className="text-xs text-[#666D80] font-medium">{stat.label}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-[#15161E]">Technology Stack</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              return (
                <div
                  key={tech.name}
                  className="bg-white rounded-[16px] border border-[#DFE1E6] p-4 flex items-center gap-3 hover:shadow-md transition-all"
                >
                  <div
                  ...
                  <div className="font-semibold text-[#15161E] text-sm">{tech.name}</div>
                </div>
              );
            })}
          </div>
          ...
          <div className="bg-white rounded-[16px] border border-[#DFE1E6] p-6 mt-6">
            <h3 className="text-sm font-bold text-[#15161E] mb-6">Application Architecture</h3>
            <div className="space-y-4">
              {/* Client Layer */}
              <div className="flex items-center justify-center">
                <div className="bg-[#F7F1FF] border border-[#9D63F6] rounded-[12px] px-6 py-3 text-center">
                  <div className="text-sm font-semibold text-[#9D63F6]">Client Layer</div>
                  <div className="text-xs text-[#666D80] mt-1">React Components + UI</div>
                </div>
              </div>

              {/* Arrow */}
              <div className="flex justify-center">
                <ArrowRight className="text-[#A4ABB8] rotate-90" size={20} />
              </div>
              ...
              <div className="flex items-center justify-center">
                <div className="bg-[#FFF4E6] border border-[#D97706] rounded-[12px] px-6 py-3 text-center">
                  ...
                  <div className="text-xs text-[#666D80] mt-1">Server & Client Components</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center">
                <div className="bg-[#F3E8FF] border border-[#9333EA] rounded-[12px] px-6 py-3 text-center">
                  ...
                  <div className="text-xs text-[#666D80] mt-1">Auth, Theme, State Management</div>
                </div>
              </div>
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                <div className="bg-[#DBEAFE] border border-[#3B82F6] rounded-[12px] px-6 py-3 text-center">
                  ...
                  <div className="text-xs text-[#666D80] mt-1">Development</div>
                </div>
                <div className="bg-[#DBEAFE] border border-[#3B82F6] rounded-[12px] px-6 py-3 text-center">
                  <div className="text-sm font-semibold text-[#1E40AF]">Real API</div>
                  <div className="text-xs text-[#666D80] mt-1">Production</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* AI Features Section */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-[#15161E]">AI Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-[#FFF4E6] to-white rounded-[16px] border border-[#D97706] p-5 hover:shadow-md transition-all">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className="font-bold text-[#15161E] text-sm">AI Listing Assistant</h3>
              </div>
              <p className="text-xs text-[#666D80] mb-3">Intelligent image recognition and categorization</p>
            ...
            <div className="bg-gradient-to-br from-[#E0E7FF] to-white rounded-[16px] border border-[#6366F1] p-5 hover:shadow-md transition-all">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className="font-bold text-[#15161E] text-sm">AI HR Assistant</h3>
              </div>
              <p className="text-xs text-[#666D80] mb-3">Natural language HR query processing</p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-xs text-[#4B5563]">
            ...
            <div className="bg-gradient-to-br from-[#DBEAFE] to-white rounded-[16px] border border-[#3B82F6] p-5 hover:shadow-md transition-all">
              <div className="flex items-start gap-3 mb-3">
                ...
                <h3 className="font-bold text-[#15161E] text-sm">AI Smart Search</h3>
              </div>
              <p className="text-xs text-[#666D80] mb-3">Intelligent cross-platform search</p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-xs text-[#4B5563]">
        ...
        {/* Integration Roadmap */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-[#15161E]">Integration Roadmap</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={idx}
                className="bg-white rounded-[16px] border border-[#DFE1E6] p-5 hover:shadow-md transition-all"
              >
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 mt-1">
                    {phase.completed ? (
                      ...
                      <Calendar size={24} className="text-[#666D80]" />
                    )}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-baseline gap-2 mb-2">
                      <span className="font-bold text-[#15161E]">{phase.phase}</span>
                      <span className="text-sm text-[#9D63F6] font-semibold">{phase.title}</span>
                      <span className="text-xs text-[#666D80] ml-auto">{phase.date}</span>
                    </div>
                    <ul className="space-y-1">
                      {phase.items.map((item, i) => (
                        <li key={i} className="text-sm text-[#4B5563] flex items-center gap-2">
                          <span className="w-1.5 h-1.5 bg-[#666D80] rounded-full"></span>
                          {item}
                        </li>
                      ))}
                    </ul>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-[#15161E]">Scalability Features</h2>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-[#15161E] text-sm mb-1">{feature.title}</h3>
                  <p className="text-xs text-[#666D80]">{feature.description}</p>
                </div>
              );
            })}
          </div>
        ...
        <section className="space-y-4">
          <div className="bg-gradient-to-br from-[#F7F1FF] to-[#F0F9FF] rounded-[16px] border border-[#9D63F6] p-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-[12px] bg-[#9D63F6] flex items-center justify-center text-white flex-shrink-0">
                <Code2 size={24} />
              </div>
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-[#15161E] mb-3">Built with AI</h2>
                ...
                <div className="bg-white rounded-[12px] border border-[#DFE1E6] p-4 mb-4">
                  <p className="font-semibold text-[#15161E] text-sm mb-2">Development Stats</p>
                  <p className="text-sm text-[#4B5563]">
                    <span className="font-bold text-[#9D63F6]">13 pages</span>, <span className="font-bold text-[#9D63F6]">10+ components</span>,{' '}
                    <span className="font-bold text-[#9D63F6]">3 AI features</span>, <span className="font-bold text-[#9D63F6]">2000+ lines of code</span> —
                    all developed in a single collaborative session.
                  </p>
                </div>

                <p className="text-sm font-semibold text-[#15161E] mb-3">How AI Accelerated Development</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2 text-sm text-[#4B5563]">
                    <span className="text-[#9D63F6] font-bold mt-0.5">✓</span>
