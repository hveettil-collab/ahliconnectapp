...
export const CORPORATE_NEWS = [
  {
    ...
    body: `His Excellency Syed Basar Shueb, Chairman of International Holding Company (IHC), delivered a keynote address at the Abu Dhabi Global Market (ADGM) Annual Investment Forum, outlining the group's ambitious vision for the next decade of growth across the UAE and beyond.\n\nSpeaking to an audience of over 500 global investors, fund managers, and government officials, the Chairman emphasised IHC's commitment to diversifying its portfolio across technology, healthcare, agriculture, and real estate — sectors he described as "the pillars of the UAE's next economic chapter."\n\n"The UAE has always been a nation that looks forward. At IHC, we see ourselves as architects of that future — building businesses that don't just generate returns, but create lasting value for our communities and our country," he said.\n\nKey highlights from the address include:\n\n• A new AED 5 billion technology venture fund focused on AI and deep tech startups across the MENA region\n\n• Expansion of IHC's healthcare vertical into Southeast Asia, with planned investments in Malaysia and Indonesia\n\n• A commitment to achieving net-zero emissions across all IHC subsidiaries by 2035\n\n• The launch of "IHC Futures" — a programme to identify and develop the next generation of Emirati business leaders\n\nThe Chairman also announced a strategic partnership with ADGM to establish a new fintech innovation hub, which will provide office space, mentorship, and seed funding to early-stage financial technology companies.\n\nThe forum, held at the ADGM Conference Centre on Al Maryah Island, brought together leaders from across the global investment community. IHC's presentation was widely praised for its clarity of vision and concrete commitments.\n\nIHC Group currently manages assets worth over AED 280 billion across more than 800 entities, making it one of the largest conglomerates in the Middle East.`,
  },
  {
    id: 'cn002',
    ...
    body: `International Holding Company (IHC) today announced its financial results for the first quarter of 2026, reporting record revenue of AED 14.8 billion — a 22% increase compared to the same period last year.\n\nThe strong performance was driven by robust growth across all major verticals, with healthcare, real estate, and technology leading the way.\n\nFinancial Highlights:\n\n• Revenue: AED 14.8 billion (up 22% YoY)\n• Net Profit: AED 4.2 billion (up 18% YoY)\n• EBITDA: AED 5.6 billion (margin of 37.8%)\n• Total Assets: AED 295 billion (up from AED 270 billion)\n\nThe healthcare division, anchored by PureHealth, contributed AED 3.9 billion in revenue, benefiting from the expansion of hospital networks across the UAE and the successful launch of telehealth services.\n\nAldar Properties delivered AED 4.1 billion in revenue, fuelled by strong demand in both residential and commercial segments, particularly the Saadiyat Island and Yas Island developments.\n\nThe technology vertical, including investments in AI, cloud computing, and cybersecurity, grew by 35% to reach AED 2.1 billion.\n\n"These results reflect the strength of our diversified portfolio and the dedication of our 45,000+ employees across the group," said the Group CEO. "We remain focused on sustainable, long-term value creation for our shareholders and the communities we serve."\n\nIHC shares closed at AED 402.50 on the Abu Dhabi Securities Exchange (ADX), up 3.2% following the announcement.`,
  },
  {
    id: 'cn003',
    ...
    body: `In the first Group Town Hall of 2026, IHC Group CEO addressed over 5,000 employees across all subsidiaries in a live-streamed event from the IHC headquarters in Abu Dhabi.\n\nThe hour-long session covered strategic priorities, celebrated achievements from the past year, and introduced several new initiatives designed to strengthen the group's position as a global leader.\n\nAI Transformation\n\nThe CEO announced the rollout of "Ahli Connect" — an AI-powered employee platform that will serve as the central hub for all HR services, benefits, internal communications, and community engagement across the group.\n\n"We're not just adopting AI — we're embedding it into the DNA of how we work. Ahli Connect will be the most advanced employee experience platform in the region," he said.\n\nEmployee Wellness\n\nA new comprehensive wellness programme was unveiled, including:\n\n• Mental health support with 24/7 counselling access\n• Flexible working arrangements across all subsidiaries\n• Enhanced parental leave — 90 days for mothers, 30 days for fathers\n• Annual wellness allowance of AED 5,000 per employee\n• Partnership with leading fitness centres across the UAE\n\nMarket Expansion\n\nThe CEO outlined plans to expand into Southeast Asia, with initial focus on Malaysia, Indonesia, and Vietnam. The group will invest AED 8 billion over the next three years in healthcare, technology, and real estate in these markets.\n\n"Southeast Asia represents one of the most exciting growth opportunities in the world. With a combined population of over 680 million people and rapidly growing middle classes, it's a natural next step for IHC," he explained.\n\nThe town hall concluded with a Q&A session where employees from across the group asked questions about career development, sustainability goals, and the future of work at IHC.`,
  },
  {
    id: 'cn004',
    ...
    author: 'IHC Ventures',
    body: `International Holding Company (IHC) and Hub71, Abu Dhabi's global tech ecosystem, today signed a Memorandum of Understanding (MoU) to jointly support and accelerate the growth of UAE-based startups.\n\nThe partnership, signed at a ceremony at Hub71's headquarters in Abu Dhabi, will see IHC commit AED 500 million in funding to early-stage and growth-stage startups operating in key sectors including fintech, healthtech, proptech, and sustainability.\n\nUnder the MoU, IHC will:\n\n• Provide seed and Series A funding to at least 50 startups over the next three years\n• Offer mentorship from senior executives across IHC's portfolio of companies\n• Grant startups access to IHC's network of 800+ entities for pilot programmes and partnerships\n• Create dedicated co-working spaces within IHC subsidiary offices\n• Host quarterly "IHC Demo Days" where startups can pitch to IHC's investment committee\n\n"Innovation is not just something we invest in — it's how we think about every aspect of our business," said the IHC Group CEO. "This partnership with Hub71 will help us identify and nurture the next generation of game-changing companies right here in the UAE."\n\nThe CEO of Hub71 added: "IHC's commitment sends a powerful signal to founders everywhere that Abu Dhabi is the place to build and scale technology companies. The combination of IHC's resources and Hub71's ecosystem creates an unparalleled platform for startup success."\n\nSince its launch in 2019, Hub71 has attracted over 400 startups from more than 50 countries, with a combined valuation exceeding AED 30 billion. The addition of IHC as a strategic partner is expected to significantly accelerate this growth.`,
  },
];
